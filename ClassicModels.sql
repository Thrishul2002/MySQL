...
CREATE DATABASE classicmodels ;/*!32312 IF NOT EXISTS*/`classicmodels` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1;classicmodelsclassicmodels
