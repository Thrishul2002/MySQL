...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_candidate_skill`(IN candidate_id INT)
BEGIN
...
INSERT INTO candidate_skills VALUES(15,2);
...
INSERT INTO employee (name,city,contact)VALUES ("chandu","Hyderabad","9828281234");
SELECT * FROM employee;
DELETE FROM employee WHERE eid=1;
USE mysqljdbc;
ALTER TABLE employee ADD COLUMN email VARCHAR(20);
DELETE FROM employee WHERE eid IN(5,12);
DROP TABLE employee;
